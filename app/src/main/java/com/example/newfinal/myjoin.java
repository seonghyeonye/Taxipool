...
public class myjoin extends Fragment {
    ...
    private void initUI(ViewGroup rootView){
        ...
        try {
            ...
            BasicDBObject query = new BasicDBObject().append("taxi.participators", ((MainActivity)getActivity()).account.getString("name"));
            System.out.println(((MainActivity)getActivity()).account.getString("name"));
...
/*
                        ...
                        new AlertDialog.Builder(getmContext())
                                ...
                                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int whichButton) {
                                        Taxitime removed = getmTaxitime().remove(position);
                                        Toast.makeText(getmContext().getApplicationContext(), "일정이 삭제되었습니다", Toast.LENGTH_SHORT).show();
        ...
        System.out.println("????");
        System.out.println(adapter.getmTaxitime());
